...
{
    public sealed class OracleConect

    {
        ...
        //public   readonly string ConnectionStringLocalTransaction = ConfigurationSettings.AppSettings["OraConnString1"];
        //public   readonly string ConnectionStringInventoryDistributedTransaction = ConfigurationSettings.AppSettings["OraConnString2"];
        //public   readonly string ConnectionStringOrderDistributedTransaction = ConfigurationSettings.AppSettings["OraConnString3"];
        //public   readonly string ConnectionStringProfile = ConfigurationSettings.AppSettings["OraProfileConnString"];
        //public   readonly string ConnectionStringMembership = ConfigurationSettings.AppSettings["OraMembershipConnString"];

        //Create a hashtable for the parameter cached 
        string conn = System.Configuration.ConfigurationManager.ConnectionStrings["ModelMGRContext"].ConnectionString;
        //public string conn = ConfigurationManager.ConnectionStrings["ModelMGRContext"].ConnectionString;
